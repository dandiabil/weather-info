...
const WeatherInfoResults = ({ results, refEl }) => {
  return (
    <>
      ...
      >
        <div
          className="w-[80vw] mx-auto card shadow-md md:max-w-screen-xl"
          ref={refEl}
        >
          <div className="w-[80%] mx-auto py-12 md:py-16">
            <section className="font-overpass">
              ...
              <div className="mb-8">
                <WeatherCheckResults
                  results={results ? results.weatherData : ""}
                />
              </div>
              <header className="w-full mb-8">
                <h2 className="text-3xl md:text-5xl font-chivo font-black text-black">
              ...
              <div>
                <WeatherForecastResults
                  results={results ? results.weatherForecast : ""}
                />
              </div>
            </section>
          </div>
